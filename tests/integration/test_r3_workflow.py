...
def _standard_script(*, discussion=None, reconsider=False):
    ...
    if reconsider:
        ...
        findings = [
            FindingV2(agent_name="terminology_reviewer", source_span="Continue button", candidate_span="继续按钮", issue_type="terminology", problem="wording choice", evidence="both preserve meaning", action="继续", confidence=0.8),
            FindingV2(agent_name="fluency_reviewer", source_span="Continue button", candidate_span="继续按钮", issue_type="fluency", problem="wording choice", evidence="both preserve meaning", action="下一步", confidence=0.8),
        ]
